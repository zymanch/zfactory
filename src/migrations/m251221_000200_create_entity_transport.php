...
/**
 * Create entity_transport table
 * Stores state of conveyors and manipulators
 */
class m251221_000200_create_entity_transport extends Migration
{
    ...
    {
        $this->dropForeignKey('fk_entity_transport_resource', 'entity_transport');
        $this->dropForeignKey('fk_entity_transport_entity', 'entity_transport');
