 ...
 * @method UserQuery filterByUpdatedAt($value, $criteria = null)
  ...
  * @method UserQuery withShipEntities($params = [])
  * @method UserQuery joinWithShipEntities($params = null, $joinType = 'LEFT JOIN', $eagerLoading = true)
  * @method UserQuery withShipLandings($params = [])
  * @method UserQuery joinWithShipLandings($params = null, $joinType = 'LEFT JOIN', $eagerLoading = true)
