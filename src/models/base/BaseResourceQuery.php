 ...
 * @method ResourceQuery filterByMaxStack($value, $criteria = null)
  ...
  * @method ResourceQuery withTechnologyCosts($params = [])
  * @method ResourceQuery joinWithTechnologyCosts($params = null, $joinType = 'LEFT JOIN', $eagerLoading = true)
  * @method ResourceQuery withTechnologies($params = [])
  * @method ResourceQuery joinWithTechnologies($params = null, $joinType = 'LEFT JOIN', $eagerLoading = true)
