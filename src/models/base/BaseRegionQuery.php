 ...
 * @method RegionQuery filterBySeed($value, $criteria = null)
 * @method RegionQuery filterByIsStarter($value, $criteria = null)
 * @method RegionQuery filterByShipAttachX($value, $criteria = null)
 * @method RegionQuery filterByShipAttachY($value, $criteria = null)
  ...
  * @method RegionQuery andJoinOnConditionBySeed($value, $criteria = null)
  * @method RegionQuery andJoinOnConditionByIsStarter($value, $criteria = null)
  * @method RegionQuery andJoinOnConditionByShipAttachX($value, $criteria = null)
  * @method RegionQuery andJoinOnConditionByShipAttachY($value, $criteria = null)
  ...
  * @method RegionQuery orderBySeed($order = Criteria::ASC)
  * @method RegionQuery orderByIsStarter($order = Criteria::ASC)
  * @method RegionQuery orderByShipAttachX($order = Criteria::ASC)
  * @method RegionQuery orderByShipAttachY($order = Criteria::ASC)
